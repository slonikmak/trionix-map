...
## Purpose
Provide a visual scale indicator widget that displays the real-world distance corresponding to a segment on the map, helping users understand the current map scale and measure approximate distances.
